...
int main()
{
    ...
    std::vector<std::pair<long long, long long>> coordinates = {{5, 3}, {7, 2}, {1, 9}, {0, 0}};
    ...
    for (const auto& coord : coordinates)
    {
        ...
        std::cout << "Random number using coordinates (" << x << ", " << y << "): " << randomNumber
                  << std::endl;
    }
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < coordinates.size(); ++i)
    {
        ...
        {
            std::cout << "  => Does not match the previous generated value. Inconsistent!"
                      << std::endl;
        }
    }
    std::cout << std::endl;
